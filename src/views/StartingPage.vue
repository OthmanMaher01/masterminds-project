                            ...
                            <div class="row justify-content-start">
                                <div class="col-lg-8">
                                    ...
                                    <div class="d-flex justify-content-evenly">
                                                                            <router-link to="/start" class="btn btn-outline-primary py-3 px-5 animated slideInDown disabled">Investor</router-link>
                                    <router-link to="/start" class="btn btn-outline-primary py-3 px-5 animated slideInDown " >Loans</router-link>

                                    <router-link to="/start" class="btn btn-outline-primary py-3 px-5 animated slideInDown disabled">Expert</router-link>
