    ...
    <div class="login-page">
          ...
          <!-- <img src="../assets/images/atypontube-logo.png" style="width:170px;"> -->
              ...
              <label for="file-upload" class="custom-file-upload">
                    <i class="fa fa-cloud-upload"></i>Upload Document That Vouch for Your CreditWorthiness Or Character(Optional)
            </label>
            <label for="file-upload" class="custom-file-upload">
                    <i class="fa fa-cloud-upload"></i>Upload Payment Record(Optional)
            </label>
            <label for="file-upload" class="custom-file-upload">
                    <i class="fa fa-cloud-upload"></i>Upload Judicial Record(Required)
            </label>
