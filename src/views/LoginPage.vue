<template>
  ...
  <div class="login-page ">
        ...
        <!-- <img src="../assets/images/atypontube-logo.png" style="width:170px;"> -->
            ...
            <div>
                <span style="color: #333333;font-weight: bold;">Don't have an account ? </span>
                <span style="color: #406c88;cursor: pointer;" @click="toRegister"> Register here</span>
            </div>
            <div class="spinner-container" v-if="isLoading">
               <div class="spinner-border text-blue" role="status"/>
               </div>
            <div class="button" align="center" @click="signin" v-else>
